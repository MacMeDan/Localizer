...
/// Generates the Resource Enum based off the contents of the Localizable.strings file. Also adds comments for each entry.
class ResourceGenerator {
    ...
    func generate() {
        ...
        //
        // `R` represents Resource a common practice used in other development environments.
        //
